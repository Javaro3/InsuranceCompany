        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InsuranceCases_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InsuranceCases_SupportingDocuments_SupportingDocumentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PolicyPayment = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PolicyClients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PolicyClients_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PolicyClients_Policies_PolicyId",
                        column: x => x.PolicyId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InsuranceCases_ClientId",
                table: "InsuranceCases",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_InsuranceCases_SupportingDocumentId",
                table: "InsuranceCases",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PolicyClients_ClientId",
                table: "PolicyClients",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_PolicyClients_PolicyId",
                table: "PolicyClients",
                column: "PolicyId");
        }
